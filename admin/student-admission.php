    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] == 0) {
        ...
        //checking file size
            ...
            if (move_uploaded_file($_FILES['photo']['tmp_name'], $path . $filename) == 1) 
            {
                ...
                $query = "INSERT INTO `students` VALUES (NULL,'$roll','$enroll','$sname','$fname','$mname','$address','$email','$dob','$age','$phone','$parentphone','$cid','$filename','$gender','$pass')";
    ...
    <div class="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                    <br><br><br>
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-1 rounded">Students Enrollment Form</h3>
                    </div>
                        ...
                        <form action="" method="post" id="myForm" enctype="multipart/form-data" name="myForm" onreset="clearPhoto()">
                            ...
                            <div class="row my-4">
                                <div class="col-md-6 my-3 text-center">
                                    <input type="submit" name="add" class="btn btn-danger" value="Add Student">
                                </div>
                                <div class="col-md-6 my-3 text-center">
