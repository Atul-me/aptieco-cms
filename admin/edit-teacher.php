<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        if(isset($_FILES['photo']) && $_FILES['photo']['error'] == 0)
        {
            ...
            else if(in_array($filetype,$allowed))
            {
                ...
                {
                    $query = "UPDATE `teachers` SET `AadhaarNumber`='$Aadhaar',`AccountNumber`='$account',`Name`='$sname',`FatherName`='$fname',`MotherName`='$mname',`Address`='$address',`Email`='$email',`DOB`='$dob',`Age`='$age',`PhoneNumber`='$phone',`ParentPhoneNumber`='$parentphone',`ClassId`='$cid',`Photo`='$filename' WHERE `id`='$id'";
                    $result = mysqli_query($conn,$query);
                    if($result)
                        echo "<script>alert('Record updated'); document.location = 'manage-teachers.php'</script>";
                    else
                    {
    ...
    {
        echo "<script>window.alert(\"Erorr : ".mysqli_error($conn)."\");";
        echo "document.location = 'manage-teachers.php'</script>";
    }
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Edit Teachers</h3>
                    </div>
                    <div class="col-md-6 mr-3 ml-auto shadow rounded bg-light pt-4 px-3 border border-danger form-div" id="form-div">
                        <form action="" method="post" id="myForm" enctype="multipart/form-data" name="myForm" onreset="clearPhoto()">
                            <div class="form-group">
                                <input type="text" class="form-control" name="Aadhaarnumber" placeholder="Enter aadhaar card no." value="<?php echo $row1[1] ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="accountlnumber" placeholder="Enter Account Number" value="<?php echo $row1[2] ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="sname" placeholder="Enter Teacher Name" value="<?php echo $row1[3] ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="parentphone" class="form-control" placeholder="Home Phone Number" value="<?php echo $row1[11] ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row my-4">
                                <div class="col-md-6 my-3 text-center">
                                    <input type="submit" name="update" class="btn btn-danger" value="update Teacher">
                                </div>
                                <div class="col-md-6 my-3 text-center">
                    ...
                    <div class="col-md-4 ml-3 mr-auto">
                        <div class="image-container shadow bg-light rounded border border-danger">
                            <div id="image-div"><img id="image" src="../photos/<?php echo $row1['Name'].'/'.$row1['Photo'] ?>" alt="teacher image"></div>
                            <div class="custom-file">
                                <input type="file" form="myForm" name="photo" class="custom-file-input" accept=".jpg,.png,.jpeg" 
                                onchange="show()" id="photo" required>
