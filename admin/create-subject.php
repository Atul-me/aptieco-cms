        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Add Subjects</h3>
                    </div>
                    <div class="col-md-8 bg-light mx-auto px-4 pt-4 mt-4 rounded shadow border border-danger">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                            ...
                            <div class="form-group text-center">
                                <input type="submit" class="btn btn-danger" value="Add Subject" name="create">
                            </div>
                        </form>
                    </div>
                </div>
