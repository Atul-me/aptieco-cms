        ...
        if(isset($_FILES['photo']) && $_FILES['photo']['error'] == 0)
        {
            ...
            else if(in_array($filetype,$allowed))
            {
                if(move_uploaded_file($_FILES['photo']['tmp_name'],$path.$filename) == 1)
                {
                    ...
                    if($result)
                        echo "<script>alert('Record updated'); document.location = 'manage-students.php'</script>";
                    else
                    {
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Edit Students</h3>
                    </div>
                        ...
                        <form action="" method="post" id="myForm" enctype="multipart/form-data" name="myForm" onreset="clearPhoto()">
                            ...
                            <div class="row my-4">
                                <div class="col-md-6 my-3 text-center">
                                    <input type="submit" name="update" class="btn btn-danger" value="update Student">
                                </div>
                                <div class="col-md-6 my-3 text-center">
                    ...
                    <div class="col-md-4 ml-3 mr-auto">
                        <div class="image-container shadow bg-light rounded border border-danger">
                            <div id="image-div"><img id="image" src="../photos/<?php echo $row1['Name'].'/'.$row1['Photo'] ?>" alt="student image"></div>
