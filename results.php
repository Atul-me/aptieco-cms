<?php
    ...
    if(isset($_POST['viewresult']))
    {
        ...
        {
            echo "<script>alert(\"Either your roll number is incorrect or your result isn't declared yet\")</script>";
        }
    }
?>
<!DOCTYPE html>
            ...
            <div class="col-md-5 mx-auto m-4 p-4 rounded bg-light p-5 m-5">
                <form action="" method="post">
                    ...
                    <div class="text-center">
                        <input type="submit" value="View Result" name="viewresult" class="btn btn-danger">
                    </div>
                </form>
            </div>
        </div>
