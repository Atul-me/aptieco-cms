        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-1 rounded">Edit Attendance</h3>
                    </div>
                    <div class="col-11 my-2 attendance-div border mx-auto border-danger rounded shadow px-5 pt-4 bg-light">
                        <form action="" method="POST">
                            ...
                            <div class="form-group text-center mt-5 mb-3">
                                <input type="submit" value="Update Attendance" class="btn btn-danger my-2" name="update">
                            </div>
                        </form>
                    </div>
                </div> <!--row-->
...
<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        {
            $query = "UPDATE attendance SET Attendance='$value' WHERE StudentId='$key'";
            $result = mysqli_query($conn, $query);
        }
