        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Edit Result</h3>
                    </div>
                    <div id="form-div" class="col-md-8 rounded bg-light mx-auto border border-danger shadow py-3 pt-5 px-4 form-div">
                        <form action="calculate-result.php" method="post">
                            ...
                            <div class="form-row my-3">
                                <div class="col-md-6 text-center my-3 py-2 bg-danger rounded-left border-right">
                                    <span class="font-weight-bold">Half Yearly exam marks MM (100)</span>
                                </div>
                                <div class="col-md-6 text-center my-3 py-2 bg-danger rounded-right border-left">
                            ...
                            <div class="form-group text-center py-4">
                                ...
                                <input type="submit" class="btn btn-danger" value="Update Result" name="updateresult">
                            </div>
                        </form>
                    </div>
                </div>
