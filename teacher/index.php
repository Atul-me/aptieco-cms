...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT `PhoneNumber`,`Password` FROM `teachers` WHERE `PhoneNumber`='$userid' AND `Password`='$password'";
        ...
        <div class="row mt-5">
            <div class="col-md-6 mx-auto mt-5">
                <form method="post" action="" class="needs-validation" name="login" novalidate>
                    <h1 class="h1 font-weight-bold text-danger text-center my-5">Teacher's Login</h1>
                    ...
                    <div class="text-center">
                        <input type="submit" class="btn btn-danger w-25 btn-lg mt-4" value="Login" name="login">
                    </div>
                </form>
            </div>
        </div>
