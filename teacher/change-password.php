<?php
    ...
    if(isset($_POST['change']))
    {
        ...
        $query = "SELECT * FROM `teachers` WHERE PhoneNumber='$userid' AND `Password`='$cpass'";
        ...
        if(mysqli_num_rows($result) == 1)
        {
            ...
            $query = "UPDATE `teachers` SET `Password`='$npass' WHERE PhoneNumber='$userid'";
            $result = mysqli_query($conn, $query);
            if($result)
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Change Password</h3>
                    </div>
                    <div class="col-md-8 col-sm-7 my-5 mx-auto bg-white p-3 pt-5 rounded shadow border border-danger">
                        <form action="" method="POST" name="myForm">
                            ...
                            <div class="text-center">
                                <input type="submit" class="btn btn-danger btn-lg mt-4" value="Change" name="change">
                            </div>
                        </form>
                    </div>
                </div>
