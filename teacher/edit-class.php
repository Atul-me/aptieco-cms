        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-danger py-2 mb-3 rounded">Edit Class</h3>
                    </div>
                    <div class="col-md-8 shadow border border-danger mx-auto rounded bg-light px-4 py-4 pt-5">
